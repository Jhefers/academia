(function () {
    ...
    function computeStats(participantFilter = 'all', weekFilter = 'all') {
        ...
        statsCards.innerHTML = `
            ...
            <div class="stat-card"><div class="stat-icon"><i class="fa-solid fa-scale-balanced"></i></div><div class="stat-info"><h3>R$&nbsp;${totalPagar.toFixed(2)}</h3><span>total distribuído</span></div></div>
        `;
    }
